...
// const deleteFormsWithId = async (id: string, role: string) => {
//   const response = await fetch(
...
//     await deleteFormsWithId(modalData.id, role);
...
//       <h1 className="mb-4 text-xl font-bold">فرم های گزارش روزانه واحد {title}</h1>
//       <DatePicker
//         calendar={persian}
//         locale={persian_fa}
//         value={selectedDate}
...
//             <a href={`http://localhost:3000/forms/${role.toLowerCase()}/${modalData.id}/get`} className="text-blue-500 mx-4 hover:text-blue-700">
//               مشاهده
//             </a>
//             <a href={`http://localhost:3000/forms/${role.toLowerCase()}/${modalData.id}/edit`} className="text-green-500 mx-4 hover:text-green-700">
//               به روز رسانی
//             </a>
//             <button onClick={handleDelete} className="text-red-500 mx-4 hover:text-red-700">
//               حذف
//             </button>
//           </div>
//         </div>
...
//           <button onClick={handleCreateNewReport} className="text-green-500 mt-2 hover:text-green-700">
//             ایجاد گزارش جدید
//           </button>
//         </div>
//       )}
